...
export default defineConfig({
  title: "antonimikeladze",
  description: "Personal page",
  base: '/antonimikeladze',
  themeConfig: {
    ...
    socialLinks: [
      { icon: 'telegram', link: 'https://t.me/antonimikeladze' },
      { icon: 'youtube', link: 'https://www.youtube.com/c/antonimikeladze' },
      { icon: 'github', link: 'https://github.com/antonimikeladze' }
    ]
  }
})
